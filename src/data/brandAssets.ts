...
export const brandAssets: Record<string, BrandAsset> = {
  'QuickBooks Online': { name: 'QuickBooks Online', logo: '/assets/brands/quickbooks.svg', colorClass: 'text-[#2ca01c]', href: '/platforms/quickbooks-online/', businessSystems: ['Accounting', 'Payroll', 'Payments', 'Reporting'] },
  'QuickBooks Enterprise': { name: 'QuickBooks Enterprise', logo: '/assets/brands/quickbooks.svg', colorClass: 'text-[#2ca01c]', businessSystems: ['Accounting', 'Inventory', 'Reporting'] },
  'Intuit Enterprise Suite': { name: 'Intuit Enterprise Suite', logo: '/assets/brands/intuit.svg', colorClass: 'text-[#236cff]', href: '/platforms/intuit-enterprise-suite/', businessSystems: ['Accounting', 'Payroll', 'Payments', 'Reporting', 'Multi-Entity'] },
  Intuit: { name: 'Intuit', logo: '/assets/brands/intuit.svg', colorClass: 'text-[#236cff]', href: '/platform-partners/intuit/', businessSystems: ['Accounting', 'Payroll', 'Payments'] },
  Xero: { name: 'Xero', logo: '/assets/brands/xero.svg', colorClass: 'text-[#13b5ea]', businessSystems: ['Accounting', 'Reporting'] },
  'Zoho One': { name: 'Zoho One', ...zohoAsset, businessSystems: ['CRM', 'Accounting', 'Automation', 'HR', 'Projects', 'Marketing'] },
  'Zoho CRM': { name: 'Zoho CRM', ...zohoAsset, businessSystems: ['CRM', 'Sales', 'Automation'] },
  'Zoho Books': { name: 'Zoho Books', ...zohoAsset, businessSystems: ['Accounting', 'Payments', 'Reporting'] },
  Bill360: {
    name: 'Bill360',
